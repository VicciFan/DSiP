...
\makeatother
    ...
    \title{DSPAssign1}\begin{titlepage} % Beginning of the title page
%
%
%
\title{
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}132}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Check data}
          ...
          \PY{n}{display}\PY{p}{(}\PY{n}{ds}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{n}{n}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
          \PY{n}{ds}\PY{o}{.}\PY{n}{info}\PY{p}{(}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}133}]:} \PY{c+c1}{\PYZsh{} counts}
          ...
          \PY{n}{f}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{index}\PY{p}{)}\PY{p}{,}\PY{n}{df}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{value\PYZus{}counts}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{values}\PY{p}{)}\PY{p}{)}\PY{p}{\PYZcb{}}\PY{p}{,} \PY{n}{ignore\PYZus{}index}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
              ...
              \PY{n}{display}\PY{p}{(}\PY{n}{dfprint}\PY{p}{)}
...
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}134}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For categorical variables:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{count\PYZus{}categorical}\PY{p}{(}\PY{n}{ds}\PY{p}{)}
          \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For numerical variables:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{display}\PY{p}{(}\PY{n}{ds}\PY{o}{.}\PY{n}{describe}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{round}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)}\PY{o}{.}\PY{n}{T}\PY{p}{)}
          \PY{n}{plot\PYZus{}hist}\PY{p}{(}\PY{n}{ds}\PY{p}{,}\PY{n}{get\PYZus{}num\PYZus{}cols}\PY{p}{(}\PY{n}{ds}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
TotalCharges    3794.7375  8684.80  
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_6_4.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_6_5.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_6_6.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}135}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Analysis of product preference}
...
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}136}]:} \PY{n}{ds\PYZus{}loyal} \PY{o}{=} \PY{n}{ds}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
          ...
          \PY{n}{display}\PY{p}{(}\PY{n}{ds\PYZus{}loyal}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{n}{n}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
          
          \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For categorical variables:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{count\PYZus{}categorical}\PY{p}{(}\PY{n}{ds\PYZus{}loyal}\PY{p}{)}
          \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{For numerical variables:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{display}\PY{p}{(}\PY{n}{ds\PYZus{}loyal}\PY{o}{.}\PY{n}{describe}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{round}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{)}\PY{o}{.}\PY{n}{T}\PY{p}{)}
          
          \PY{n}{plot\PYZus{}bars}\PY{p}{(}\PY{n}{ds\PYZus{}loyal}\PY{p}{)}
...
TotalCharges    4264.125  8672.45  
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_9_6.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_9_7.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_9_8.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_9_9.png}
    \end{center}
    { \hspace*{\fill} \\}
...
[15 rows x 21 columns]
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_9_11.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_9_12.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_9_13.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_9_14.png}
    \end{center}
    { \hspace*{\fill} \\}
    \begin{Verbatim}[commandchars=\\\{\}]
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}137}]:} \PY{n}{ds\PYZus{}churn} \PY{o}{=} \PY{n}{ds}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
          ...
          \PY{n}{display}\PY{p}{(}\PY{n}{ds\PYZus{}churn}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{n}{n}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
          
          \PY{n}{plot\PYZus{}hist2}\PY{p}{(}\PY{n}{ds\PYZus{}loyal}\PY{p}{,}\PY{n}{ds\PYZus{}churn}\PY{p}{,}\PY{n}{get\PYZus{}num\PYZus{}cols}\PY{p}{(}\PY{n}{ds}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
Empirical Distribution of Variable tenure
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_12_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Empirical Distribution of Variable MonthlyCharges
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_12_5.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Empirical Distribution of Variable TotalCharges
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_12_7.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}138}]:} \PY{n}{data} \PY{o}{=} \PY{n}{ds\PYZus{}loyal}\PY{o}{.}\PY{n}{drop}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gender}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{SeniorCitizen}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Partner}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Dependents}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{PaperlessBilling}\PY{l+s+s2}{\PYZdq{}}
...
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}139}]:} \PY{n}{data} \PY{o}{=} \PY{n}{data}\PY{o}{.}\PY{n}{dropna}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}140}]:} \PY{n}{data} \PY{o}{=} \PY{n}{data}\PY{o}{.}\PY{n}{replace}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{No phone service}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{No}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}141}]:} \PY{n}{data}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ServiceCount}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{iloc}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Yes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}142}]:} \PY{n}{data} \PY{o}{=} \PY{n}{data}\PY{o}{.}\PY{n}{drop}\PY{p}{(}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{PhoneService}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{MultipleLines}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{InternetService}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{OnlineSecurity}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Onl}
...
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}143}]:} \PY{n}{data} \PY{o}{=} \PY{n}{data}\PY{o}{.}\PY{n}{astype}\PY{p}{(}\PY{n+nb}{float}\PY{p}{)}
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}144}]:} \PY{c+c1}{\PYZsh{}plt.figure()}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_20_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
density.
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}145}]:} \PY{n}{scatter2} \PY{o}{=}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_22_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}146}]:} \PY{n}{data1} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{n}{data}\PY{o}{.}\PY{n}{ServiceCount} \PY{o}{\PYZgt{}} \PY{l+m+mi}{5}\PY{p}{]}
          \PY{n}{data2} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{n}{data}\PY{o}{.}\PY{n}{ServiceCount} \PY{o}{\PYZlt{}} \PY{l+m+mi}{5}\PY{p}{]}
\end{Verbatim}
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}147}]:} \PY{n}{scatter3} \PY{o}{=}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_25_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}148}]:} \PY{n}{scatter4} \PY{o}{=}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_27_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}149}]:} \PY{n}{scatter5} \PY{o}{=}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_29_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}150}]:} \PY{n}{scatter6} \PY{o}{=}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{DSPAssign1_files/DSPAssign1_31_0.png}
    \end{center}
    { \hspace*{\fill} \\}
